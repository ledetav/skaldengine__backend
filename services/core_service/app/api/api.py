...
from app.api.endpoints import user_personas, characters, lore, sessions, asset_upload, scenarios
...
api_router.include_router(asset_upload.router, prefix="/upload", tags=["Media Assets"])