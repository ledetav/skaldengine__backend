...
def upgrade() -> None:
    ...
    sa.Column('speech_style', sa.String(), nullable=True),
    sa.Column('character_name_snapshot', sa.String(), nullable=True),
    sa.Column('persona_name_snapshot', sa.String(), nullable=True),
